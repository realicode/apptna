package com.realaicy.mb.android.apptna.data;




import com.realaicy.mb.android.apptna.entity.c.MultipleItem;
import com.realaicy.mb.android.apptna.entity.c.MySection;
import com.realaicy.mb.android.apptna.entity.c.Status;
import com.realaicy.mb.android.apptna.entity.c.Video;
...
public class DataServer {
    ...
    public static List<Status> getSampleData(int lenth) {
        ...
        for (int i = 0; i < lenth; i++) {
            ...
            status.setUserName("本地消息——消息标题" + i);
            status.setCreatedAt("11/05/" + i);
            status.setRetweet(i % 2 == 0);
            status.setUserAvatar("https://avatars1.githubusercontent.com/u/7698209?v=3&s=460");
            status.setText("消息内容测试，消息内容测试，消息内容测试。");
            list.add(status);
        }
        return list;
    }
