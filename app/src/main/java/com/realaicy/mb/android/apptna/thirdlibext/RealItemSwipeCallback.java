package com.realaicy.mb.android.apptna.thirdlibext;
 ...
 */
public class RealItemSwipeCallback extends ItemTouchHelper.Callback {
    ...
    public RealItemSwipeCallback(BaseItemDraggableAdapter adapter) {
        mAdapter = adapter;
    }
